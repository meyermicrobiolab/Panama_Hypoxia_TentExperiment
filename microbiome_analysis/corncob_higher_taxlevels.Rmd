...
fams <- ggplot(DAplot, aes(x=Family, y=proportion))+
  ...
  geom_errorbar(aes(ymin=proportion-se, ymax=proportion+se, color=Timepoint), width=.1)+
  theme(legend.text = element_text(size=12))
fams


#  geom_errorbar(aes(ymin=proportion-Std.Error, ymax=proportion+Std.Error, color=Timepoint), width=.1)+
```
