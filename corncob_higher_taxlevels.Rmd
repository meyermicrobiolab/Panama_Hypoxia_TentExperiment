...
# this keep the ASV label as the row names in the taxa table (and column names in otu table)
...
### Now use corncob to look for differentially abundant taxa at the family level in the low oxygen treatment across both coral species
...
### Now use corncob to look for differentially abundant taxa at the order level in the low oxygen treatment across both coral species
